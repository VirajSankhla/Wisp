...
import { n as auth } from "./server-C-nNZrP2.mjs";
import { n as TriangleAlert } from "../_libs/lucide-react.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-DMbn0Zhz.js
var router_DMbn0Zhz_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-utcpuPbK.css";
var APP_NAME = "Wisp";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Heading-first notes that sit at the edge of your screen."
			},
			{
				name: "theme-color",
				content: "#12110f"
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AuthProvider, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
					...
					toastOptions: { className: "!bg-bg-elevated !text-fg !border-border !font-sans !shadow-panel" }
				})] }),
...
var $$splitComponentImporter$1 = () => import("./routes-orulaSGo.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-BvSWcmvn.mjs");
...
//#endregion
export { getRouter, router_DMbn0Zhz_exports as t };
