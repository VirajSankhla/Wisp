...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DS3dXiU0.mjs");
...
var manifest = {
	"1dcf70a1722ebc3930865cdaa4175ef71d73f64ad9f432c9ec9ff7ef684fe2b7": {
		functionName: "listNotes_createServerFn_handler",
		importer: () => import("./server-WVx0ngHi.mjs")
	},
	"e78c2f532e390e54d95e521d0d8844a3a23ea4b9937fc7f812104c6218f7a030": {
		functionName: "upsertNote_createServerFn_handler",
		importer: () => import("./server-WVx0ngHi.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DMbn0Zhz.mjs").then((n) => n.t),
